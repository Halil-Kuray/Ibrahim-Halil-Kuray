    ...
    <Section color={data.color}>
      ...
      >
        ...
        {data.image && (
          ...
          >
            <img
              className="absolute w-full rounded-3xl max-w-xs md:max-w-none h-auto blur-2xl brightness-150 contrast-[0.9] dark:brightness-150 saturate-200 opacity-50 dark:opacity-30 mix-blend-multiply dark:mix-blend-hard-light"
              src={data.image.src}
              aria-hidden="true"
            />
            <img
              className="relative z-10 w-full max-w-xs rounded-3xl md:max-w-none h-auto"
              alt={data.image.alt}
              src={data.image.src}
            />
          </div>
